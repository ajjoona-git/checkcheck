  ...
  <div class="page-wrapper">
    <div class="container py-5">
      ...
      <div v-if="store.moathons.length > 0" class="moathon-grid fade-in">
        <MoathonCard v-for="moathon in store.moathons" :key="moathon.id" :moathon="moathon" />
      </div>
      ...
      <div class="pagination-wrapper" v-if="store.count > 0">
        <Pagination :current-page="store.currentPage" :total-count="store.count" :items-per-page="24"
          :display-page-count="5" @change-page="handlePageChange" />
      </div>
    </div>
  </div>
</template>
