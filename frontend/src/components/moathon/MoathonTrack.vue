<template>
  <div class="moathon-track-container">
    <svg width="100%" height="100%" viewBox="0 0 600 300" class="track-svg" preserveAspectRatio="xMidYMid meet">
      ...
      <path :d="trackPathData" fill="none" :stroke="trackBgColor" :stroke-width="strokeWidth" stroke-linecap="butt" />

      <path ref="trackPath" :d="trackPathData" fill="none" :stroke="trackColor" :stroke-width="strokeWidth"
        stroke-linecap="butt" class="progress-path" />

      <path :d="trackPathData" fill="none" stroke="rgba(255,255,255,0.3)" :stroke-width="2" stroke-dasharray="10, 10" />
